<template>
  <div class="d-flex">
    ...
    <aside class="px-2 white--text">
      <!--  filter-component almost-dumb component    -->
      <filter-component :schema="getFilterComponentsSchema" />
    </aside>
    <!--  list container  -->
    <v-container class="pa-0">
      <v-row class="ml-2">
        <v-col cols="9">
          <!--  search-component almost-dumb component    -->
          <search-component />
        </v-col>
        <v-col cols="3" class="align-self-center">
        <!--   Pagination   todo- please do pagination. it as an assignment  -->
...
export default {
  name: "FilmsView",
  components: { FilterComponent, SearchComponent, ListViewComponent },
  computed: {
    ...mapGetters("appSchema", ["getFilterComponentsSchema"]),
  },
};
</script>
<style>
